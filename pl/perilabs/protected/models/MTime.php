...
/**
 * This is the model class for table "m_time".
 *
 * The followings are the available columns in table 'm_time':
 ...
 */
class MTime extends CActiveRecord
{
	 ...
	 * @return MTime the static model class
	 */
