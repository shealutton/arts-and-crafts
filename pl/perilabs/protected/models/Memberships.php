...
return Yii::app()->db2;
	...
	public function rules()
	{
      ...
      array('user__id+organization__id', 'application.extensions.uniqueMultiColumnValidator', 'caseSensitive'=>true, 'message'=>"A user with that email address is already associated with this experiment"),
