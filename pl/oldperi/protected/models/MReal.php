...
/**
 * This is the model class for table "m_real".
 *
 * The followings are the available columns in table 'm_real':
 ...
 */
class MReal extends CActiveRecord
{
	 ...
	 * @return MReal the static model class
	 */
