...
/**
 * This is the model class for table "v_real".
 *
 * The followings are the available columns in table 'v_real':
 ...
 */
class VReal extends CActiveRecord
{
	 ...
	 * @return VReal the static model class
	 */
