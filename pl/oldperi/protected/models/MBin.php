...
/**
 * This is the model class for table "m_bin".
 *
 * The followings are the available columns in table 'm_bin':
 ...
 */
class MBin extends CActiveRecord
{
	 ...
	 * @return MBin the static model class
	 */
