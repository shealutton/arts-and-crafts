...
/**
 * This is the model class for table "v_time".
 *
 * The followings are the available columns in table 'v_time':
 ...
 */
class VTime extends CActiveRecord
{
	 ...
	 * @return VTime the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('variable__id, trial__id', 'numerical', 'integerOnly'=>true),
