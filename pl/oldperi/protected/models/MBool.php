...
/**
 * This is the model class for table "m_bool".
 *
 * The followings are the available columns in table 'm_bool':
 ...
 */
class MBool extends CActiveRecord
{
	 ...
	 * @return MBool the static model class
	 */
