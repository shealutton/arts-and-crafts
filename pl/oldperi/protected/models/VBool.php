...
/**
 * This is the model class for table "v_bool".
 *
 * The followings are the available columns in table 'v_bool':
 ...
 */
class VBool extends CActiveRecord
{
	 ...
	 * @return VBool the static model class
	 */
