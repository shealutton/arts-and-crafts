...
class Trials extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			//array('trial_id, experiment__id, title', 'required'), //Commented 20120209
			array('experiment__id, title', 'required'), //Added 20120209 
			//array('trial_id, experiment__id, sequence_num', 'numerical', 'integerOnly'=>true), //Commented 20120209
