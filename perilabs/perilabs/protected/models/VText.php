...
/**
 * This is the model class for table "v_text".
 *
 * The followings are the available columns in table 'v_text':
 ...
 */
class VText extends CActiveRecord
{
	 ...
	 * @return VText the static model class
	 */
