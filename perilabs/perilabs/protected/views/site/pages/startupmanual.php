...
<div class="container-fluid centered">
   ...
   <div class="frontpage margintop">
      <div class="row-fluid">
         <div class="span8">
         <h1>Are You Following The Startup Owner's Manual?</h1>
         <p>Then you know how important it is to test your business concepts!</p>
	    <ul>
	       <li>Do people <b>Need</b> your product?</li>
	       <li>Will people <b>Pay</b> for your product?</li>
	    </ul>
         </br>
         <h2>Peri Labs can help you run these critical tests</h2>
         <p>Peri Labs lets you test validate your business assumptions on your target markets.</p>
