	...
	<div class="row-fluid">
		...
		<tbody>
			...
			<td class="price">2</td>
                        ...
                        <tr>
                        <td><strong>People On Your Team/Organization</strong></td>
                        <td class="price">Unlimited</td>
                        <td class="price">Unlimited</td>
                        <td class="price">Unlimited</td>
                        <td class="price">Unlimited</td>
			...
			<td class="price"><?php echo CHtml::link("Unlimited", array('user/registration?plan=huge'), array('class'=>"btn btn-primary")) ?></td>
			<td class="price"><?php echo CHtml::link("Large", array('user/registration?plan=large'), array('class'=>"btn btn-primary")) ?></td>
			<td class="price"><?php echo CHtml::link("Medium", array('user/registration?plan=medium'), array('class'=>"btn btn-primary")) ?></td>
			<td class="price"><?php echo CHtml::link("Small", array('user/registration?plan=small'), array('class'=>"btn btn-primary")) ?></td>
			<td class="price"><?php echo CHtml::link("Free", array('user/registration?plan=free'), array('class'=>"btn btn-primary")) ?></td>
			</tr>
		</tbody>
		</table>
			<div class="frontpage">
	...
	<div class="frontpage well margintop">
		...
		<div class="row-fluid margintop">	
			<div class="span6">
				...
				<p>If you choose to use our website, <a href="https://perilabs.com">Peri Labs.com</a>, there is no software to install. Peri Labs runs on our servers in a secure cloud so you don’t have to worry about software upgrades, security patches, or configuration. Just log in and start running experiments.</p>
				<h3>Is there an enterprise version I can run at my office?</h3>			
				<p>Yes! The <?php echo CHtml::link("Peri Research Platform", array('site/page', 'view'=>'prp')) ?> is available if you prefer enterprise software to be installed on your hardware. Please contact us for more information. <a href="mailto:sales@perilabs.com">Contact our sales team</a>.</p>
