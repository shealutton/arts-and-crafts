...
class VariablesTimeController extends Controller
{
	/**
	...
	public function actionCreate()
        {
                $model=new VariablesTime;

                // Uncomment the following line if AJAX validation is needed
                // $this->performAjaxValidation($model);

                if(isset($_POST['VariablesTime']))
                {
                        $model->attributes=$_POST['VariablesTime'];
                        ...
                        if($model->save()) {
                            if(Request::isAjax()) {
                                ...
                                $this->redirect(array('view','id'=>$model->var_time_id));
                            }
                        }
                } else {
	...
	{
		$dataProvider=new CActiveDataProvider('VariablesTime');
	...
	{
		$model=new VariablesTime('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['VariablesTime']))
			$model->attributes=$_GET['VariablesTime'];
	...
	{
		$model=VariablesTime::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='variables-time-form')
		{
