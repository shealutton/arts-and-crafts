...
/**
 * This is the model class for table "m_int".
 *
 * The followings are the available columns in table 'm_int':
 ...
 */
class MInt extends CActiveRecord
{
	 ...
	 * @return MInt the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('metric__id, result__id, value', 'numerical', 'integerOnly'=>true),
