...
/**
 * This is the model class for table "v_bin".
 *
 * The followings are the available columns in table 'v_bin':
 ...
 */
class VBin extends CActiveRecord
{
	 ...
	 * @return VBin the static model class
	 */
